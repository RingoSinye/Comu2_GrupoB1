...
import sip
import triceratops_epy_block_2 as epy_block_2  # embedded python block



class triceratops(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "triceratops")
        ...
        self.qtgui_number_sink_0.set_title('VALOR PROMEDIO')
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, 2, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, 2, 0, 0)
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.epy_block_2, 0))
        self.connect((self.blocks_throttle_0_1_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.epy_block_2, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.epy_block_2, 1), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.epy_block_2, 2), (self.qtgui_number_sink_0_1, 0))
        self.connect((self.epy_block_2, 3), (self.qtgui_number_sink_0_2, 0))
        self.connect((self.epy_block_2, 4), (self.qtgui_number_sink_0_3, 0))
...
def main(top_block_cls=triceratops, options=None):
